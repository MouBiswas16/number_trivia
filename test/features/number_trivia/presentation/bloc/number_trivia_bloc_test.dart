...
void main() {
  ...
  group(
    ...
    () {
      ...
      final tNumberTrivia = NumberTrivia(text: "test tiriva", number: 1);
      ...
      test(
        ...
        () async {
          ...
          // act
          bloc?.dispatch(GetTriviaForConcreteNumber(tNumberString));
          await untilCalled(mockGetConcreteNumberTrivia(tNumberParsed));
          // assert
    ...
    () {
      ...
      test(
        ...
        () async {
          // arrange
          when(mockGetRandomNumberTrivia(NoParams()))
              .thenAnswer((_) async => Left(Failure as Failure));
          // assert later
          final expected = [
            Empty(),
            Loading(),
